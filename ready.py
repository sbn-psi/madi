...
def check_ready(previous_fullbundle, delta_fullbundle) -> None:
    ...
    errors = do_checkready(delta_fullbundle, previous_fullbundle)
...
def do_checkready(delta_fullbundle: pds4.FullBundle, previous_fullbundle: pds4.FullBundle) -> List[validator.ValidationError]:
    errors = []
